...
a 태그로 href를 이용할경우 html 파일명을 작성해주는 것이기 때문에 React에서는
...
* Router = 연결을 해주는데 연결 경로를 자동으로 전환해서 주는 기능
           ...
           웹 사이트에 요청할 경우 고객이 요청한 흐름대로 자연스럽게 
           보여주는 기능
...
2. router를 사용하기 위해 4가지 설정
   ...
   Link          : 사용자가 누르고 이동할 수 있는 링크 생성 <a href> 똑같은 역할
...
3. 사용 방법
  ...
  *주의 사항*
  BrowserRouter는 index.js나 App.js 에서 사용
